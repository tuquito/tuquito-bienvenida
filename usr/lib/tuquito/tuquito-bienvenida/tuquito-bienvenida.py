...
class Welcome():
    def __init__(self):
        ...
        text['fundation'] = _('Fundation Tuquito Libre')
        text['fundation2'] = _('Join Tuquito Foundation')
    ...
    def title_changed(self, view, frame, title):
        ...
        elif title == 'event_fundation':
            os.system('xdg-open http://fundacion.tuquito.org.ar')
